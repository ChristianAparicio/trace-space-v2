...
<figure class="banner">
<img class="banner-img" src="${product.img1}" alt="">
</figure>
...
<div class="product-imgs">
  ...
  <div class="img-select">
      <div class="img-list[0]">
          <a href="#"  data-id="1">
              <img class="selction-img" src="${product.img1}" alt="">
          </a>
      </div>

      <div class="img-list[0]">
          <a href="#" data-id="2">
              <img class="selction-img" src="${product.img2} "alt="">
          </a>
      </div>

      <div class="img-list[0]">
          <a href="#" data-id="3">
              <img class="selction-img" src="${product.img3}" alt="">
          </a>
      </div>
...
<h2 class="text-product-title"> ${product.Name}</h2>
<div class="product-price">
<p class="text-price-title">Price: <span class="price">$${product.Price}</span></p>
</div>
<ul>
<li class="text">Release Year: <span class="text-li-info">${product.year}</span> </li>
<li class="text">Author: <span class="text-li-info">${product.Author}</span></li>
